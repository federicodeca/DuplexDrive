<?php
/* Smarty version 5.5.1, created on 2025-07-12 00:40:47
  from 'file:carsForRentlist.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_687192ef040958_00585013',
...
function content_687192ef040958_00585013 (\Smarty\Template $_smarty_tpl) {
...
">
 ...
 <!-- Page Content pagination (smarty side only)-->
     ...
     <div class="page-heading about-heading header-text" style="background-image: url(/DuplexDrive/directory/Smarty/assets/images/heading-6-1920x500.jpg);">
      ...
      <?php $_smarty_tpl->assign('page', (($tmp = $_GET['page'] ?? null)===null||$tmp==='' ? 1 ?? null : $tmp), false, NULL);?> <!-- Current page, default to 1 if not set reda page=x smarty variable-->
...
?>
  <?php if ($_smarty_tpl->getValue('index') >= $_smarty_tpl->getValue('start') && $_smarty_tpl->getValue('index') < $_smarty_tpl->getValue('end')) {?>
    ...
    <a href='/DuplexDrive/Rent/selectCarForRent/<?php echo $_smarty_tpl->getValue('car')->getIdAuto();?>
'>
