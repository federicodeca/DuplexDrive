<?php
/* Smarty version 5.5.1, created on 2025-07-12 00:40:22
  from 'file:home.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_687192d6ad3c16_21909459',
...
function content_687192d6ad3c16_21909459 (\Smarty\Template $_smarty_tpl) {
      ...
      <div class="container">
        <div class="row">
          ...
          <?php if ($_smarty_tpl->getSmarty()->getModifierCallback('count')($_smarty_tpl->getValue('offers')) > 2) {?>
            ...
            <div class="col-md-4">
                <a href='/DuplexDrive/Sale/selectCarForSale/<?php echo $_smarty_tpl->getValue('offers')[0]->getIdAuto();?>
'>
...
€ <small>prezzo listino</small></h6>
            ...
            <div class="col-md-4">
                <a href='/DuplexDrive/Sale/selectCarForSale/<?php echo $_smarty_tpl->getValue('offers')[1]->getIdAuto();?>
'>
                  <div class="product-item">
...
€ <small>prezzo listino</small></h6>
           ...
           <div class="col-md-4">
                <a href='/DuplexDrive/Sale/selectCarForSale/<?php echo $_smarty_tpl->getValue('offers')[2]->getIdAuto();?>
'>
                  <div class="product-item">
...
€ <small>prezzo listino</small></h6>
    ...
    <?php if ((true && ($_smarty_tpl->hasVariable('lastCar') && null !== ($_smarty_tpl->getValue('lastCar') ?? null)))) {?>
    <div class="mt-3"></div>
    ...
    <div class="offers">
      <div class="container">
        <div class="row">
          ...
          <?php if (($_smarty_tpl->getValue('lastCar')->getEntity() == 'ECarForSale')) {?> 
           <div class="col-md-4">
                <a href='/DuplexDrive/Sale/selectCarForSale/<?php echo $_smarty_tpl->getValue('lastCar')->getIdAuto();?>
'>
                  <div class="product-item">
                    <?php if ($_smarty_tpl->getValue('lastCar')->getIcon()) {?>
                      <img class="product-item-icon" src="data:<?php echo $_smarty_tpl->getValue('lastCar')->getIcon()->getType();?>
;base64,<?php echo $_smarty_tpl->getValue('lastCar')->getIcon()->getEncodedData();?>
" loading="lazy" alt="Img">
                    <?php } else { ?>
                      <img src="/DuplexDrive/directory/Smarty/assets/images/default-car.jpg" loading="lazy" alt="Nessuna immagine disponibile">
                    <?php }?>
                    <div class="down-content">
                      <h4><i class="fas fa-gas-pump mr-2"></i><?php echo $_smarty_tpl->getValue('lastCar')->getBrand();?>
 <?php echo $_smarty_tpl->getValue('lastCar')->getModel();?>
</h4>
                      <h6><i class="fa-solid fa-money-check-dollar mr-2"></i> <small>from:</small> <?php echo $_smarty_tpl->getValue('lastCar')->getPrice();?>
€ <small>prezzo listino</small></h6>
                      <h6><i class="fa-solid fa-hourglass-start mr-2"></i><small>condizione: </small> <?php echo $_smarty_tpl->getValue('lastCar')->getKm0OrNew();?>
</h6>
                      <h6><i class="fa-solid fa-droplet mr-2"></i><small>alimentazione: </small><?php echo $_smarty_tpl->getValue('lastCar')->getFuelType();?>
 </h6>
                    </div>    
                  </div>
                </a>
          ...
          <?php } else { ?>
            <a href='/DuplexDrive/Rent/selectCarForRent/<?php echo $_smarty_tpl->getValue('lastCar')->getIdAuto();?>
'>
            <div class="product-item" >
              <?php if ($_smarty_tpl->getValue('lastCar')->getIcon() && $_smarty_tpl->getValue('lastCar')->getIcon()->getEncodedData()) {?>
            <img class="product-item-icon" src="data:<?php echo $_smarty_tpl->getValue('lastCar')->getIcon()->getType();?>
;base64,<?php echo $_smarty_tpl->getValue('lastCar')->getIcon()->getEncodedData();?>
" loading="lazy" alt="Img">
              <?php } else { ?>
              ...
              <?php }?>
              <div class="down-content">
                <h4><?php echo $_smarty_tpl->getValue('lastCar')->getBrand();?>
 <?php echo $_smarty_tpl->getValue('lastCar')->getModel();?>
</h4>
                <h6><small>from</small> <?php echo $_smarty_tpl->getValue('lastCar')->getBasePrice();?>
€ <small>per day </small></h6>
                <p><?php echo $_smarty_tpl->getValue('lastCar')->getDescription();?>
</p>
              </div>
              </a>
            </div>
