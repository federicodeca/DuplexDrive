<?php
/* Smarty version 5.5.1, created on 2025-07-11 23:51:03
  from 'file:userProfile.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_687187472d8273_32238747',
...
function content_687187472d8273_32238747 (\Smarty\Template $_smarty_tpl) {
                    ...
                    <form method="post" action="/DuplexDrive/User/changePassword">
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control" id="newPassword" name="new" required minlength="8"  pattern='(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).&#123;8,&#125;'  title="La password deve contenere almeno 8 caratteri, una lettera maiuscola, una minuscola e un numero.">
                        </div>
                        <div class="form-group">
                          <label for="confirmPassword">Conferma Password</label>
                          <input type="password" class="form-control" id="confirmPassword" name="confirm" required minlength="8"  pattern='(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).&#123;8,&#125;'  title="Ripeti la password con gli stessi criteri di sicurezza.">
                        </div>
                      </div>
