<?php
/* Smarty version 5.5.1, created on 2025-07-12 17:00:04
  from 'file:carsForSaleList.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_687278744d4d23_11209970',
...
function content_687278744d4d23_11209970 (\Smarty\Template $_smarty_tpl) {
...
?>
                          <li><a class="dropdown-item"  onclick="selectBrand('<?php echo $_smarty_tpl->getValue('brand');?>
...
">
                              <a class="dropdown-item"  onclick="selectModel('<?php echo $_smarty_tpl->getValue('model');?>
...
?>
      ...
      <div class="col-md-4">
        <a href='/DuplexDrive/Sale/selectCarForSale/<?php echo $_smarty_tpl->getValue('car')->getIdAuto();?>
'>
        ...
        <div class="row justify-content-center">
          ...
          <nav aria-label="Pagination">
            <ul class="pagination">
                ...
                <li class="page-item"> 
                  <a class="page-link" href="/DuplexDrive/Sale/showCarsForSale/<?php echo $_smarty_tpl->getValue('currentPage')-1;?>
">Previous</a>
                </li>
              <?php } else { ?>
              ...
              <?php if ($_smarty_tpl->getValue('prevPage') >= 1) {?>
                <li class="page-item">
                  <a class="page-link" href="/DuplexDrive/Sale/showCarsForSale/<?php echo $_smarty_tpl->getValue('prevPage');?>
"><?php echo $_smarty_tpl->getValue('prevPage');?>
              ...
              <li class="page-item active " aria-current="page">
                <a class="page-link" href="/DuplexDrive/Sale/showCarsForSale/<?php echo $_smarty_tpl->getValue('currentPage');?>
"><?php echo $_smarty_tpl->getValue('currentPage');?>
              ...
              <?php if ($_smarty_tpl->getValue('nextPage') <= $_smarty_tpl->getValue('totalPages')) {?>
                <li class="page-item">
                  <a class="page-link" href="/DuplexDrive/Sale/showCarsForSale/<?php echo $_smarty_tpl->getValue('nextPage');?>
